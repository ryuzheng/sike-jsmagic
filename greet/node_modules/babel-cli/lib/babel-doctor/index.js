...
while (nodeModulesDirectories.length) {
  ...
  for (var _iterator = packagesNames, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);;) {
    var _ref;
...
function run() {
  var promises, key, fn, results, _iterator2, _isArray2, _i2, _ref2, success, message, multiline;
  ...
  return _regeneratorRuntime.async(function run$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 12:
        ...
        _iterator2 = results, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _getIterator(_iterator2);
